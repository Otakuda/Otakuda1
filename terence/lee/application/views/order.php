...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/orders.css">
...
<p class="title">
<a href="<?= base_url(); ?>information">我的美团</a></p>
<p class="title">
<a href="<?= base_url(); ?>order">我的订单</a></p>
<ul class="link-ul">
...
<ul class="link-ul">
<li><a href="">收藏的商家</a><span class="num"></span>
<i class="icon-right"></i></li>
</ul></div>
<div class="link-group">
<p class="title">
<a href="<?= base_url(); ?>evaluate">我的评价</a></p><ul class="link-ul">
<li><a href="">待评价</a>
<span class="num"></span><i class="icon-right"></i></li>
<li><a href="">已评价</a>
<span class="num"></span><i class="icon-right"></i></li></ul></div>
<div class="link-group">
<p class="title"><a href="<?= base_url(); ?>setting">个人信息</a></p>
<ul class="link-ul">
<li><a href="<?= base_url(); ?>setting">账户设置</a><span class="num"></span><i class="icon-right"></i></li></ul></div></div>
...
<li class="">待使用</li>
<li class="">待评价</li>
<li class="">退款/售后</li></ul></div>
<div class="orders-body"><div>
<p class="no-order-text">您暂时还没有订单</p></div></div>
<div class="btn-box">
<a class="left-arrow iconfont icon-btn_left "></a>
<a class="right-arrow iconfont icon-btn_right "></a></div></div></div>
