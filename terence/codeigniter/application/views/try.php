...
<head>
   ...
   <body id="main">
    <link rel="stylesheet" type="text/css" href="../css/com_header1.css">
    <header class="com-header"><div class="header-bar">
        ...
        <div class="header-bar-position">
            ...
            <a class="growth-entry user-importent" href="<?= base_url(); ?>register">立即登录</a>
                ...
                <nav class="header-bar-nav">
                    ...
                    <li><a rel="nofollow" href="" target="_blank">我的订单</a></li>
                    <li><a rel="nofollow" href="" target="_blank">我的评价</a></li>
                    <li><a rel="nofollow" href="" target="_blank">我的收藏</a></li>
                    <li><a rel="nofollow" href="" target="_blank">账户设置</a></li>
                    </ul></a></li>
                    <li><a href="" target="_blank">手机APP</a></li>
                    <li class="has-child">身份状态
                        <ul class="header-nav-merchant header-nav-second">
                        <li><a rel="nofollow" href="" target="_blank">用户</a></li>
                        <li><a rel="nofollow" href="" target="_blank">商家</a></li>
                        </ul>
                        </li>
                        ...
                        <a href="">
                        <img src="../fb/logo.png" alt="Otakuda"></a></div></div>
                        ...
                        <div class="header-search-hasinput"><ul></ul></div></div>
                        <div class="header-search-hotword">
                        <a href="">欢乐超市</a>
                        <a href="">锦合超市</a>
                        <a href="">big eaon</a>
...
<div class="right-banner">
    <div class="home-header-links">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="" data-bid="b_lalhpjhj" data-lab="{&quot;custom&quot;:{&quot;title&quot;:&quot;蔬菜&quot;}}" class="link waimai-link" title="蔬菜" target="_blank">蔬菜</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="" data-bid="b_lalhpjhj" data-lab="{&quot;custom&quot;:{&quot;title&quot;:&quot;肉类&quot;}}" class="link maoyan-link" title="肉类" query="utm_source=meituanweb" data-query="utm_source=meituanweb" target="_blank">肉类</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="" data-bid="b_lalhpjhj" data-lab="{&quot;custom&quot;:{&quot;title&quot;:&quot;海鲜&quot;}}" class="link hotel-link" title="海鲜" target="_blank">海鲜</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="" data-bid="b_lalhpjhj" data-lab="{&quot;custom&quot;:{&quot;title&quot;:&quot;水果&quot;}}" class="link homestay-link" title="水果" target="_blank">水果</a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="banner-row clearfix">
        ...
        <div class="slider" id="banner-slider">
            ...
            <div class="slider-img-div" style="background-image:url(../fb/1.jpg)"></div>
            </div>
            
            <div class="slider-item">
            <div class="slider-img-div" style="background-image:url(../fb/2.jpg)"></div></a></div>
            <div class="slider-item" >
            <div class="slider-img-div" style="background-image:url(../fb/3.jpg)">
            </div></div>
            <div class="slider-item"">
            <div class="slider-img-div" style="background-image:url(../fb/v1.jpg)"></div></div>
             <div class="slider-item" >
             <div class="slider-img-div" style="background-image:url(../fb/v2.jpg)"></div></div>
            <div class="slider-item">
            <div class="slider-img-div" style="background-image:url(../fb/v3.jpg)"></div>
       </div></div>
        ...
        <i class="iconfont icon-btn_left" ></i></div></div></div>

        <a href="" data-bid="b_a4enk0wd" data-lab="{&quot;custom&quot;:{&quot;index&quot;:2}}" class="link" target="_blank">
        <div class="item shadow pic-1" style="background-image:url(../fb/bat.jpg"></div></a>


        <div class="item banner-logincard">

            <div style="float:left">
            <div class="login-container"><div class="default" style="display:block"
            >
            <div class="head-img-row"><img src="../fb/user.png" alt=""></div><p class="user-name">Hi！你好</p>
            ...
            <div class="icon">
            <i class="iconfont icon-setting_iconx"></i></div></a></div>
            <div class="head-img-row"><a href="" target="_blank">
                <img src="../fb/scan.jpg" alt=""></a>
        </div>
...
<div class="banner-row clearfix">
    <a href="" data-bid="b_a4enk0wd" data-lab="{&quot;custom&quot;:{&quot;index&quot;:3}}" class="link" target="_blank">
    <div class="item pic-2 shadow" style="background-image:url(../fb/v1.jpg"></div></a>
    <a href="" data-bid="b_a4enk0wd" data-lab="{&quot;custom&quot;:{&quot;index&quot;:4}}" class="link" target="_blank">
    <div class="item pic-3 shadow" style="background-image:url(../fb/v2.jpg"></div></a>
    <a href="" data-bid="b_a4enk0wd" data-lab="{&quot;custom&quot;:{&quot;index&quot;:5}}" class="link" target="_blank">
    <div class="item pic-4 shadow" style="background-image:url(../fb/hand.jpg"></div></a>
    <div class="item download-app">
        <div class="qrcode-box">
            <img src="../fb/scan.png" alt="下载APP"></div>
        ...
        <footer class="com-footer">
            ...
            <dl>
                <dt>用户帮助</dt>
                <dd><a rel="nofollow" href="" target="_blank">美团承诺</a></dd>
                <dd><a rel="nofollow" href="" target="_blank">购物保障</a></dd>
                <dd><a rel="nofollow" href="" target="_blank">申请退款</a></dd>
                <dd><a rel="nofollow" href="" target="_blank">查看美团券密码</a></dd>
            ...
            <dl>
                ...
                <dd><a href="" target="_blank">美团外卖开店申请</a></dd>
