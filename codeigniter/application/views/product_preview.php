...
<div id="bd" class="yui3-g">
    <div class="yui3-u-1 stepBar-wrap" id="yui_3_12_0_4_1531808580258_2035">
        ...
        <div class="step-bar">
            <ol class="step-list">
                ...
                <li class="step done"><span class="step-number">2</span> <span class="step-name">商品資訊與規格</span> <span
                            class="icon-next-step"></span></li>
                <li class="step current"><span class="step-number">3</span> <span class="step-name">預覽</span> <span
                            class="icon-next-step"></span></li>
    ...
    <div>
        <div id="isoredux-root">
            <div id="itemPreview" class="pageRoot__2VRqJ " data-reactroot="">
                <div class="pageRowBox__3xNZf">
                    <section class="previewInfoWrap__3L8oc">
                        <div class="inner__1kUlf"><h2 class="title__3SBcO">商品刊登預覽</h2>
                            <div class="decorations__27qQx"><em></em><em class="arrow__C5DDd"></em></div>
                            <ul>
                                <li class="previewRow__1HXjq"><span class="caption__1FjF1">商品類型：</span><span
                                            class="value__yfL74">直購商品</span></li>
                                <li class="previewRow__1HXjq"><span class="caption__1FjF1">商品分類：</span><span
                                            class="value__yfL74"><span class="breadcrumbList__1eEyf">男性精品與服飾</span><span
                                                class="breadcrumbList__1eEyf">男裝</span><span class="breadcrumbList__1eEyf">品牌T恤</span><span
                                                class="breadcrumbList__1eEyf">8-Style</span></span></li>
                                <li class="previewRow__1HXjq"><span class="caption__1FjF1">上架類型：</span><span
                                            class="value__yfL74">立即刊登</span></li>
                                <li class="previewRow__1HXjq"><span class="caption__1FjF1">刊登費用：</span><span
                                            class="value__yfL74">0<!-- --> </span></li>
                                <li class="previewRow__1HXjq"><span class="note__WSPwk">注意事項：建議您送出本商品頁前再檢視一次刊登費用金額，商品成功上架後將產生相關費用。</span>
                                </li>
                            </ul>
                        </div>
                    </section>
                                ...
                                <div class="pure-g firstFold__1T18d">
                                    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-2-5 itemImages__1firo">
                                        <section class="wrap__bGMYC">
                                            <div>
                                                <figure class="focusedImageFigure__c4PVd"><img
                                                            ...
                                                            class="focusedImage__3HmoX "></figure>
                                            </div>
                                            <ul class="imageList__22FSs">
                                                <li class="listItem__3BRt8">
                                                    ...
                                                    <img src="https://s.yimg.com/xd/api/res/1.2/wwfhNdInA_Cvi4vZrcKXaA--/YXBwaWQ9eXR3YXVjdGlvbnNlcnZpY2U7Zmk9ZmlsbDtoPTkwO3E9ODU7cm90YXRlPWF1dG87dz05MA--/https://s.yimg.com/ma/f4e5/frontend/b7b6d0d2-88f9-49e6-a4fa-2faebec20209.jpg.cf.jpg"
                                                         class="image__3l8Vh"></li>
                                                <li class="listItem__3BRt8"><img
                                    ...
                                    <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5 itemBasic__mAugX">
                                        <section class="wrap__3MZRM"><h1 class="title__3wBva">qqq</h1>
                                            ...
                                            <div class="row__-8aqS">
                                                ...
                                                <div class="content__3X3yq"><em class="price__2f7Jw">$11</em><span
                                                            class="soldQuantity__1So65">/ 已售出 <em>0</em> 件</span></div>
                                            </div>
                                            <form id="addCartForm"><input type="hidden" name="listingId" value=""><input
                                                        type="hidden" name="productId"
                                                        value="PREVIEW_DUMMY_PRODUCT_ID"><input type="hidden" name="modelId"
                                                                                                value="newSpecId-newOptionId"><input
                                                        type="hidden" name="cartType" value="normal"><input type="hidden"
                                                                                                            name="wssid"
                                                                                                            value="">
                                                <ul class="specList__3TA_I"></ul>
                                                <div class="row__1kjJO row__-8aqS">
                                                    <div class="caption__xNd14 caption__2IQBR"><span>數量</span></div>
                                                    <div class="content__36o8N content__3X3yq">
                                                        <button class="qtyButton__2r29Y qtyMinusButton__2isH0"><i
                                                                    class="fi-minus qtyButtonIcon__2LVNb"></i></button>
                                                        <input type="number" class="qtyInput__1dbgq " min="1" max="1"
                                                               name="quantity" value="1">
                                                        <button class="qtyButton__2r29Y qtyPlusButton__2NOnk"><i
                                                                    class="fi-plus qtyButtonIcon__2LVNb"></i></button>
                                                    </div>
                                                </div>
                                                <div class="row__-8aqS actionButtons__GoaRG">
                                                    ...
                                                    <div class="imButtonBox__3f_5J"><a
                                                                ...
                                                                href="/chat?mid="><i
                                                                    ...
                                                                    class="imButtonText__1h_FG">即時通</span></a></div>
                                                </div>
                                            </form>
                                            ...
                                            <ul class="functionList__2dnPV">
                                                <li class="functionListItem__31GHt"><a target="_blank"
                                                                ...
                                                                title="分享到Facebook"></i><i class="tip--wrap__i__1GRRH">分享到
                                                            Facebook</i></a></li>
                                                <li class="functionListItem__31GHt"><a target="_blank"
                                                                                       class="previewDisableAction tip--wrap__3Sbrx"
                                                                                       href="https://timeline.line.me/social-plugin/share?url=https://tw.bid.yahoo.com/item/"><i
                                                                class="functionIcon__2C0Zx line__2x7KL" title="分享到Line"></i><i
                                                                class="tip--wrap__i__1GRRH">分享到 Line</i></a></li>
                                                <li class="functionListItem__31GHt"><a href="#copy-link"
                                                                ...
                                                                class="fi-link functionIcon__2C0Zx" title="複製商品網址"></i><i
                                                                class="tip--wrap__i__1GRRH">複製商品網址</i></a></li>
                                                <li class="functionListItem__31GHt"><a
                                                            class="reportAbuse__2eDPG tip--wrap__3Sbrx" target="_blank"
                                                            href="/item/abuse?aid="><i class="fi-flag functionIcon__2C0Zx"
                                                                                       title="檢舉商品"></i><i
                                                                class="tip--wrap__i__1GRRH">檢舉商品</i></a></li>
                                            </ul>
                                        </section>
                                    </div>
                                </div>
