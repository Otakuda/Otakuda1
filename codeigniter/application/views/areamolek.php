...
<div id="react"><div class="page index" data-reactroot=""><div class="op-area"><div class="cities-wrapper clearfix"><div width="50%">ABC水果店<br>地址：Taman Molek<br>电话:xxxxxxx<br>营业时间:xxxxxxxx<div float="right"></div><div style="float: right;"><img src="../fb/bat.jpg" height="200"></div></div>

</div></div></div></div></div></div><div class="citylist"><h3 class="l-attr">
