...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/main2.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/index1.css">
    
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/collections.css">
                ...
                <nav class="header-bar-nav">
                 ...
                 <li><a rel="nofollow" href="<?= base_url(); ?>order" target="_blank">我的订单</a></li>
                    ...
                    <li class="has-child">身份状态
                        ...
                        <img src="<?= base_url() ?>fb/logo.png" alt="Otakuda"></a>
...
<ul class="link-ul">
<li><a href="<?= base_url(); ?>order">全部订单</a>
<i class="icon-right"></i></li>
<li><a href="">待付款</a>
<i class="icon-right"></i></li>
...
<div class="link-group">
<p class="title">
<a href="<?= base_url(); ?>collection">我的收藏</a></p>
<ul class="link-ul">
<li><a href="">收藏的商家</a>
...
<ul class="link-ul"><li><a href="">待评价</a>
<span class="num"></span>
<i class="icon-right"></i></li>
<li><a href="">已评价</a><span class="num"></span>
<i class="icon-right"></i></li></ul></div>
<div class="link-group"
><p class="title">
<a href="<?= base_url(); ?>setting">个人信息</a></p>
<ul class="link-ul">
<li><a href="<?= base_url(); ?>setting">账户设置</a><span class="num"></span>
...
<span class="gary">吃喝玩乐</span></p></div></div></div>
<div class="collections-box">
<div class="orders">
<div class="orders-head">
<ul class="orders-ul clearfix">
<a href="">
<li class="active">待评价</li></a>
...
<p class="text">
<span class="title">您确定要删除收藏的商家吗？</span><br>
<span class="title2"></span></p>
<div class="btn-group">
<button class="btn btn-ok">确认</button><button class="btn btn-cancel">取消</button></div></div></div><div class="dialog-container fadeOut"><div class="dialog-box"><p class="text"><span class="title">您确定要删除收藏的团购吗？</span><br><span class="title2"></span></p><div class="btn-group"><button class="btn btn-ok">确认</button><button class="btn btn-cancel">取消</button></div></div></div><div class="col-poi"><div class="no-collections">您还没有收藏</div></div></div><div class="page-box" style="display: block;"></div><div class="page-box" style="display: none;"></div></div></div></div></div></div>
        <link rel="stylesheet" type="text/css" href="<?= base_url() ?>css/com_footer1.css">
