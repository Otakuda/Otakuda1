  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-md-6 right-side">
        ...
        <span class="input input--hoshi">
          <input class="input__field input__field--hoshi" type="password" id="password1" name="password1">
        ...
        <div class="cta">
          <button onclick="signup()" class="btn btn-primary pull-left" name="register">
            Sign-Up Now
          </button>
