        ...
        <table width="555" border="0" cellspacing="0" cellpadding="0" class="board_add2">
          <tr>
            <td width="115" rowspan="2" align="center" valign="top"><br />
              ...
              [ <a href="admin_boardDel.php?board_id=<?php echo $row_web_board['board_id']; ?>&amp;delSure=1" onclick="tfm_confirmLink('確定刪除本資料?');tfm_confirmLink('確定刪除資料?');return document.MM_returnValue">刪除本資料</a> ] </td>
