...
<form action="<?php echo base_url();?>index.php/rider/Rider_C/start_read" method="post">
...
<form action="<?php echo base_url();?>index.php/rider/Questions/quizdisplay" method="post">
