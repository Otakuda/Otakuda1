                ...
                <div class="stat-widget-four">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-heading">顧客評分</div>
                            <div class="stat-text">4.72</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="stat-widget-four">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-heading">商家評分</div>
                            <div class="stat-text">5</div>
                        </div>
                    </div>
                </div>
            </div>
