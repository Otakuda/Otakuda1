                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">9月1日</strong>
                        </div>
                        <div class="card-body">
        ...
        <div class="animated fadeIn">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">9月2日</strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                <thead>
                                ...
                                <tr>
                                    <td>#2</td>
                                    <td>新順利</td>
                                    <td>20,Jln Ros Merah 2/8</td>
                                    <td>Mr Chong</td>
                                    <td>55,Jln Impian Emas 14</td>
                                    <td>50</td>
                                    <td>
                                        <!--<button type="button" class="fa-search" data-toggle="modal" data-target="#mediumModal">-->
                                        <button type="button" data-toggle="modal" data-target="#mediumModal">
                                ...
                                <tr>
                                    <td>#3</td>
                                    <td>阿順哥</td>
                                    <td>29,Jln Ros Merah 2/8</td>
                                    <td>Mr Chong</td>
                                    <td>Taman University</td>
                                    <td>50</td>
                                    <td>
                                        <!--<button type="button" class="fa-search" data-toggle="modal" data-target="#mediumModal">-->
                                        <button type="button" data-toggle="modal" data-target="#mediumModal">
