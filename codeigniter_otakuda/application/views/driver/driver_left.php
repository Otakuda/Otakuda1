    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="">
                ...
                <br>
                <?php
                if ($this->session->userdata('number_of_times') == 0) {
                    echo 0;
                } else {
                    $num1 = $this->session->userdata('rate_mark');
                    $num2 = $this->session->userdata('number_of_times');
                    $total = $num1 / $num2;
                    echo round($total, 1);
                }
                ?>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-puzzle-piece"></i><a href="<?= base_url() ?>rider/Driver_new_order">新訂單</a>
                        </li>
                        <li><i class="fa fa-id-badge"></i><a
                                    href="<?= base_url() ?>rider/Driver_order_record/getRecord/<?= $this->session->userdata('rider_id') ?>">訂單歷史記錄</a>
                        </li>
                    </ul>
                </li>
                <li class="active">
                ...
                <li class="active">
                    <a href="<?= base_url(); ?>rider/driver_login/logout/<?= $this->session->userdata('rider_id') ?>">
                        <i
                                class="menu-icon fa fa-sign-out"></i>退出</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>
